...
function calcPairSources(member) {
  ...
  return [{
    ...
    amount,
    note: `${rankRate(member, "pair")}% dari kaki terlemah ${pv(pairedPv)} (kiri ${pv(member.leftPv || 0)}, kanan ${pv(member.rightPv || 0)})`
  }];
}
...
function dashboardView() {
  ...
  const pairStatus = bonusTotals.rawPair <= 0
    ...
    : pairIsMainCause
      ...
      : "Bonus Pasangan dihitung penuh dari kaki terlemah sesuai rate peringkat";
  ...
  return `
    ...
    <details class="card detail-card" style="margin-top:16px">
      ...
      <div class="bonus-grid">
        ...
        <div class="bonus-row"><span>Pasangan Tertahan karena 55%</span><b>Tidak ada</b></div>
        ...
        <div class="bonus-row"><span>Faktor Bayar Pasangan</span><b>100%</b></div>
      ...
      <p class="notice">Rasio ${payoutRatio}% dihitung dari Total Dibayar ${money(totalPayout)} dibagi TNPV Perusahaan ${money(companyTnpvRupiah)}. Bonus Pasangan dihitung penuh dari kaki terlemah sesuai rate peringkat; dashboard tetap menampilkan total payout keseluruhan agar admin bisa audit jika komponen lain ikut membesar.</p>
  ...
  return `
    ...
    <article class="card" style="margin-top:16px">
      ...
      <div class="rules-table">
        ...
        <div class="rule-item"><b>Bonus Pasangan 15%</b><p>Mulai Royal Star 12%, Crown Star 13%, Leader Ambassador 14%, Leader Majestic sampai Executive Director 15%. Bonus dihitung dari kaki terlemah: rate peringkat x PV terpasang/lebih kecil, maksimal Rp250 juta per member per bulan.</p></div>
